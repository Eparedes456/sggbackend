...
import com.example.demo.config.security.filter.JwtAuthenticationEntryPoint;
import com.example.demo.config.security.filter.JwtAuthorizationTokenFilter;
import com.example.demo.config.service.AuthService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.cors().and()
				...
				.antMatchers("/api/v1/pruebita/**").permitAll()
				.antMatchers("/webjars/**").permitAll()
				.antMatchers("/resources/**").permitAll()
				.antMatchers("/api/v1/recurso/**").permitAll()
				.antMatchers("/api/**")
				.authenticated(); 
